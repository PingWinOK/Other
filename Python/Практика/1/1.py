...
class vulnerability:
    ...
    def comparison(rank1, rank2):
        if(rank1 < rank2):
            print("Серьезная уязвимость")
        else:
            print("Не серьезная уязвимость")



Yiazvimost1 = vulnerability("Уязвивость опасная","Удаляет файлы",1)
Yiazvimost2 = vulnerability("Средняя степень опасности","Выводит картинку на экран",5)
Yiazvimost1.stats()
Yiazvimost2.stats()
Yiazvimost1.edit_description("Зашифровывает файлы")
Yiazvimost1.stats()
